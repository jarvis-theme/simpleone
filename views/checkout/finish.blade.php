			...
			<div class="row">
				<div class="span12">
					<div class="well">
						...
						<br>
						<h3>ID ORDER: {{$pengaturan->invoice}}{{$order->kodeOrder}}</h3><p>Total Harga Belanjaan: {{jadiRupiah($order->total)}}</p>
						<hr>
				...
				@if($datapembayaran=='1')
					<div class="span12">
						<div class="well">
							...
							<p>Silahkan anda melakukan pembayaran kesalah satu rekening berikut</p>
							<br>
							<table class="table">
