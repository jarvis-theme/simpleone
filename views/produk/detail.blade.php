					...
					<div class="span5">
						...
						@if($produk->gambar1!='')
							<li class="producthtumb">
								<a class="thumbnail" id="thumb1">
									<img src="{{product_image_url($produk->gambar1,'thumb')}}" alt="thumbnail-1" >
								</a>
							</li>
						@endif
						@if($produk->gambar2!='')
							<li class="producthtumb">
								<a class="thumbnail">
									<img src="{{product_image_url($produk->gambar2,'thumb')}}" alt="thumbnail-2" >
								</a>
							</li>
						@endif
						@if($produk->gambar3!='')
							<li class="producthtumb">
								<a class="thumbnail">
									<img src="{{product_image_url($produk->gambar3,'thumb')}}" alt="thumbnail-3" >
								</a>
							</li>
						@endif
						@if($produk->gambar4!='')
							<li class="producthtumb">
								<a class="thumbnail">
									<img src="{{product_image_url($produk->gambar4,'thumb')}}" alt="thumbnail-4" >
								</a>
							</li>
						@endif
						</ul>
